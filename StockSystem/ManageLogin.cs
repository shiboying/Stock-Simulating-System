...
namespace StockSystem
{
    public partial class ManageLogin : Form
    {
        ...
        {
            MessageBox.Show("用户"+StockSystem.Spebra.otheruser[0].getname()+"所持A股票数：" + StockSystem.Spebra.otheruser[0].getAstock().ToString() + "  所持B股票数：" +StockSystem.Spebra.otheruser[0].getBstock().ToString()+"\n"+
                "用户" + StockSystem.Spebra.otheruser[1].getname() + "所持A股票数：" + StockSystem.Spebra.otheruser[1].getAstock().ToString() + "  所持B股票数：" + StockSystem.Spebra.otheruser[1].getBstock().ToString() + "\n" +
                "用户" + StockSystem.Spebra.otheruser[2].getname() + "所持A股票数：" + StockSystem.Spebra.otheruser[2].getAstock().ToString() + "  所持B股票数：" + StockSystem.Spebra.otheruser[2].getBstock().ToString() + "\n" +
                "用户" + StockSystem.Spebra.otheruser[3].getname() + "所持A股票数：" + StockSystem.Spebra.otheruser[3].getAstock().ToString() + "  所持B股票数：" + StockSystem.Spebra.otheruser[3].getBstock().ToString() + "\n" +
                "用户" + StockSystem.Spebra.otheruser[4].getname() + "所持A股票数：" + StockSystem.Spebra.otheruser[4].getAstock().ToString() + "  所持B股票数：" + StockSystem.Spebra.otheruser[4].getBstock().ToString() + "\n" +
                "用户" + StockSystem.Spebra.otheruser[5].getname() + "所持A股票数：" + StockSystem.Spebra.otheruser[5].getAstock().ToString() + "  所持B股票数：" + StockSystem.Spebra.otheruser[5].getBstock().ToString() + "\n" +
                "用户" + StockSystem.Spebra.otheruser[6].getname() + "所持A股票数：" + StockSystem.Spebra.otheruser[6].getAstock().ToString() + "  所持B股票数：" + StockSystem.Spebra.otheruser[6].getBstock().ToString() + "\n" +
                "用户" + StockSystem.Spebra.otheruser[7].getname() + "所持A股票数：" + StockSystem.Spebra.otheruser[7].getAstock().ToString() + "  所持B股票数：" + StockSystem.Spebra.otheruser[7].getBstock().ToString() + "\n" +
                "用户" + StockSystem.Spebra.otheruser[8].getname() + "所持A股票数：" + StockSystem.Spebra.otheruser[8].getAstock().ToString() + "  所持B股票数：" + StockSystem.Spebra.otheruser[8].getBstock().ToString() + "\n" +
            "用户"+StockSystem.Spebra.otheruser[9].getname()+"所持A股票数：" + StockSystem.Spebra.otheruser[9].getAstock().ToString() + "  所持B股票数：" +StockSystem.Spebra.otheruser[9].getBstock().ToString());
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                store[i] = StockSystem.Spebra.otheruser[i].getmoney();
                name[i] = StockSystem.Spebra.otheruser[i].getname();
            }
            SortSelect.ClassSort.BubbleSort(store, 10);
            MessageBox.Show("按照用户余额由低到高排序："+"\n"+
                "用户" + name[0] + "的账户余额为：" + store[0].ToString() + "\n" +
                "用户" + name[1] + "的账户余额为：" + store[1].ToString() + "\n" +
                "用户" + name[2] + "的账户余额为：" + store[2].ToString() + "\n" +
                "用户" + name[3] + "的账户余额为：" + store[3].ToString() + "\n" +
                "用户" + name[4] + "的账户余额为：" + store[4].ToString() + "\n" +
                "用户" + name[5] + "的账户余额为：" + store[5].ToString() + "\n" +
                "用户" + name[6] + "的账户余额为：" + store[6].ToString() + "\n" +
                "用户" + name[7] + "的账户余额为：" + store[7].ToString() + "\n" +
                "用户" + name[8] + "的账户余额为：" + store[8].ToString() + "\n" +
                "用户" + name[9] + "的账户余额为：" + store[9].ToString());
            

        }

        private void a股票ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (signala == false)
            {
                signala = true;
        ...
        private void b股票ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (signalb == false)
            {
                signalb = true;
